...
int main()
{
    ...
    while(1){
        ...
        buffer[0]='2';
        buffer[1]='0';
        buffer[2]=time[6]/10 + '0';              //YEAR
        buffer[3]=time[6]%10 + '0';
        buffer[4]='-';
        buffer[5]=time[4]/10 + '0';              //Month
        buffer[6]=time[4]%10 + '0';
        buffer[7]='-';
        buffer[8]=time[3]/10 + '0';              //Date
        buffer[9]=time[3]%10 + '0';
        buffer[10]=' ';
        buffer[11]=time[2]/10 + '0';             //Hour
        buffer[12]=time[2]%10 + '0';
        buffer[13]=':';
        buffer[14]=time[1]/10 + '0';             //Minute
        buffer[15]=time[1]%10 + '0';
        buffer[16]=':';
        buffer[17]=time[0]/10 + '0';             //Second
        buffer[18]=time[0]%10 + '0';
        buffer[19]='\n';

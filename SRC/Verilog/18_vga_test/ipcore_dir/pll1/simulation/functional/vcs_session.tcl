...
gui_sg_addsignal -group pll1_group {{Status_control}} -divider
gui_sg_addsignal -group pll1_group {pll1_tb.RESET}
gui_sg_addsignal -group pll1_group {pll1_tb.LOCKED}
